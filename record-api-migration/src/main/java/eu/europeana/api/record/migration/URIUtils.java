...
public final class URIUtils {
    ...
    private static final Pattern URI_PATTERN = Pattern.compile("^([a-zA-Z][a-zA-Z+-.]*):.+$");

    // EA-3703 urn pattern added. Should be treated differently
    private static final Pattern URN_PATTERN = Pattern.compile("^urn:[a-z0-9][a-z0-9-]{0,31}:.+$", Pattern.CASE_INSENSITIVE);

    private static final Set<String> schemes = new HashSet<>();

    static {
        schemes.add("iid"); //iid:5249/SP.1
        schemes.add("aaa");
        schemes.add("aaas");
        schemes.add("about");
        schemes.add("acap");
