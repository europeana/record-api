...
public class RecordControllerV2 {
    ...
    private static final Logger LOGGER = LogManager.getLogger(RecordControllerV2.class);

    private final RecordService recordService;
    private final FormatHandlerRegistryV2 formatHandlerRegistryV2;

    @Autowired
    public RecordControllerV2(RecordService recordService, FormatHandlerRegistryV2 formatHandlerRegistryV2) {
        this.recordService = recordService;
        this.formatHandlerRegistryV2 = formatHandlerRegistryV2;
    }
    ...
    private ResponseEntity<StreamingResponseBody> createResponse(String datasetId, String localId, HttpServletRequest request) throws EuropeanaApiException {
        ...
        StreamingResponseBody responseBody = new StreamingResponseBody() {
            ...
            public void writeTo(OutputStream out) throws IOException {
                formatHandlerRegistryV2.get(recordRequest.getRdfFormat()).write(providedCHO, out);
                out.flush();
            }
        };
